...
<?php _e('Skip to content', 'super-minimal');?></a>
    ...
    <?php if (display_header_text()): ?>
        <h1 class="blog-title"><a href="<?php echo esc_url(home_url()); ?>">
			"There are only <div style="text-align:center"><span class='title-emphasis'>two rules of life</span>",</div> my father would say, <div class='title-emphasis-sm'>"it's not fair, and it doesn't make sense"</div></a></h1>
